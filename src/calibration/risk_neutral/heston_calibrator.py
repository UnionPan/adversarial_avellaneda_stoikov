...
class HestonCalibrator:
    ...
    def __init__(
        ...
        Args:
            pricer: Pricer object with price() method (e.g., COSPricer)
                   If None, uses built-in Heston characteristic function
    ...
    def _compute_prices(
        ...
        Uses characteristic function integration (simplified COS-like approach).
        """
        kappa, theta, xi, rho, v0 = params
        ...
        for i in range(len(targets['strikes'])):
            ...
            # Use Heston characteristic function for pricing
            price = self._heston_price(S0, K, T, r, kappa, theta, xi, rho, v0, is_call)
            prices[i] = price
    ...
    def _heston_price(
        ...
        """
        Price European option under Heston using CF integration.
        
        Simplified implementation - for production, use your COSPricer.
        """
        # Integration bounds
        N = 64
        u_max = 50
